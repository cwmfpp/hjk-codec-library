...
#ffhjkcodec
install-ffhjkcodec:
	$(INSTALL) -m 0755 -d $($(INSTALL)_LIBRARY_PATH) $($(INSTALL)_INCLUDE_PATH)
	$(INSTALL) -m 0644 $(OBJ_INC) $($(INSTALL)_INCLUDE_PATH)
	$(INSTALL) -m 0644 $(COMPILER_DIR)/$(OBJ_SHARED) $($(INSTALL)_LIBRARY_PATH)
	$(INSTALL) -m 0644 $(COMPILER_DIR)/$(OBJ_SHARED_SO) $($(INSTALL)_LIBRARY_PATH)
	$(INSTALL) -m 0644 $(COMPILER_DIR)/$(OBJ_SHARED_VERSION) $($(INSTALL)_LIBRARY_PATH)
	$(INSTALL) -m 0755 -d $($(INSTALL)_LIBRARY_PATH)/pkgconfig
	$(INSTALL) -m 0644 ffhjkcodec.pc $($(INSTALL)_LIBRARY_PATH)/pkgconfig
